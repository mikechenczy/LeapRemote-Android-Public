...
public class MediaProjectionHelper {
    ...
    public MediaProjection getMediaProjection() {
        return mediaProjectionService.mediaProjection;
    }
    ...
    public void startService(Activity activity) {
        ...
        // 启动媒体投影服务
        mediaProjectionManager = (MediaProjectionManager) activity.getApplication().getSystemService(Context.MEDIA_PROJECTION_SERVICE);
        if (mediaProjectionManager != null) {
        ...
        MediaProjectionService.bindService(activity.getApplicationContext(), serviceConnection);
    }
    ...
    public void stopService(Context context) {
        ...
        if (serviceConnection != null) {
            MediaProjectionService.unbindService(context.getApplicationContext(), serviceConnection);
     ...
     * @param callback callback
     */
    public void startMediaCodec(MediaCodecCallback callback) {
        startMediaCodec(callback, 50);
    }

    public void startMediaCodec(MediaCodecCallback callback, int resolution) {
        if (mediaProjectionService == null) {
            callback.onFail();
            return;
        }
        mediaProjectionService.startRecording(callback, resolution);
    }

    public boolean isHevc() {
        return mediaProjectionService.isHevc();
    }
    ...
    public void stopMediaCodec() {
        ...
        mediaProjectionService.destroyVirtualDisplay();
    }
